...
include('sidebar.php'); 
  ...
  <?php echo '<a href="form_artikel.php" class="btn btn-large"> Tambah artikel </a>';  ?>
  ...
  <ul class="pagination">
       <li><a href="data_artikel.php?page=<?php echo $page-1;?>">&laquo;</a></li>
       <?php for ($i=1; $i <=$num_page; $i++) {
         ...
         echo "<li><a class=\"{$class}\" href=\"{$link}\">{$i}</a></li>";
                ...
                <li><a href="data_artikel.php?page=<?php echo $page+1;?>">&raquo;</a></li>
              </ul>
  <?php endif; ?>